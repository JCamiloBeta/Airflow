...
default_args = {}
with DAG(dag_id="control_alarmas_dag", description="Dag para mostrar los trigger_rules a traves de un ejemplo de Control de Alarmas", start_date=datetime(2025, 1, 25),end_date = datetime(2025,2,25), schedule="@daily",
...
"""Las tareas se definen de la forma \[t1,t2,t3] >> t4 ya que no causa dependencias una de la otra ya uqe si se pone&#x20;
t1>>t2>>t3 >> t4 al final t4 dependera de la situacion de t3
